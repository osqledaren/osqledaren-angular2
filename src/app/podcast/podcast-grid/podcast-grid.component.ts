...
@Component({
  ...
  styleUrls: ['podcast-grid.component.scss'],
...
export class PodcastGridComponent extends UILoadableComponent {
  ...
  private args: PodcastQueryParams;

  constructor(private NS: PodcastService,
  ...
  private initializeData() {
    ...
    this.sub = this.route.params.subscribe(params => {
      ...
      this.masonryOptions = {
        ...
        itemSelector: '.podcast-grid-item',
